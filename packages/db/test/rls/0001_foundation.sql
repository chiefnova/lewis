...
values
  ('00000000-0000-0000-0000-000000000001', 'manufacturer', 'active', 'Manufacturer A'),
...
values
  ('10000000-0000-0000-0000-000000000001', 'user_manufacturer', 'manufacturer@example.test', 'Manufacturer User'),
  ('10000000-0000-0000-0000-000000000002', 'user_patient', 'patient@example.test', 'Patient User');

insert into tenant_memberships (user_id, tenant_id, role)
values
  ('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'manufacturer_admin'),
...
select ok(app.is_tenant_member('00000000-0000-0000-0000-000000000001'::uuid), 'manufacturer user is member of manufacturer tenant');
select ok(not app.is_tenant_member('00000000-0000-0000-0000-000000000003'::uuid), 'manufacturer user is not member of patient tenant');
