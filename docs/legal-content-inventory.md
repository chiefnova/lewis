...
| PPA data-sharing language | PRD manufacturer data-sharing decision | Counsel | Not started | Sprint 2 | MVP 1 options: aggregate-only or de-identified line-level safety. |
